...
<head>
   ...
   <title>Muhammad Fiqri Perdana 18630575</title>
   <style>
      html {
         position: relative;
         min-height: 100%;
         ...
         <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
               ...
               <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Link
                  </a>
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                     ...
                     <a class="dropdown-item" href="https://sia.uniska-bjm.ac.id" target="_blank">Website SIA UNISKA</a>
                  </div>
               </li>
               </li>
            </ul>
