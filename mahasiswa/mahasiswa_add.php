         ...
         <div class="card-body">
            <form method="POST" action="?page=mahasiswa-add" class="form-horizontal">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nim" placeholder="Masukan NIM..." required> </div>
               <div class="form-group"> <label for="nama" class="control-label">Nama Lengkap</label>
