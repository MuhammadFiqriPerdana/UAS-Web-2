    ...
    <form action="?page=user-show" method="POST">
      <div class=" input-group mb-3">
        ...
        <div class="input-group-append">
          <button class="btn btn-primary" type="submit" value="Cari" id="button-search" name="search">Cari !</button> </div>
      </div>
    </form>
    <!-- <div class="col-md-12"> -->
      ...
      <ul class="pagination justify-content-end">
        ...
        for ($i = $start_number; $i <= $end_number; $i++) {
          ...
          echo '<li class="page-item ' .
            $link_active . '"><a class="page-link" href="?page=user-show&halaman=' . $i . '">' . $i . '</a></li>';
        }
        if ($page == $jumlah_page) {
